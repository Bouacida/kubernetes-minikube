...
You can also use git: `git clone https://github.com/Bouacida/kubernetes-minikube`
...
```
docker build -t chahrazedbouacida/myservice:2 .
```
...
Start the container:
```
docker run -p 4000:8080 -t myservicechahrazedbouacida/myservice:2
```
...
* NodePort: Exposes the Service on each Node’s IP at a static port (the NodePort). A ClusterIP Service, to which the NodePort Service routes, is automatically created. You’ll be able to contact the NodePort 
...
The yaml file for the deployment: https://github.com/Bouacida/kubernetes-minikube/blob/main/myservice-deployment.yml

The yaml file for the node port service: https://github.com/Bouacida/kubernetes-minikube/blob/main/myservice-service.yml

The yaml file for the node port service: https://github.com/Bouacida/kubernetes-minikube/blob/main/myservice-loadbalancing-service.yml
...
A yaml file for ingress: https://github.com/Bouacida/kubernetes-minikube/blob/main/ingress.yml
